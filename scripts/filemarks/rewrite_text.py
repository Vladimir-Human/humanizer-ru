...
PROMPTS = {
    ...
    # B2: контрастное вычитание (аудит 2026-08-25) — бьёт в сигнал
...
# Итеративная цепочка Слоя B (аудит 2026-08-25): петля перезаписи
...
def _exec_backend(prompt):
    """Opt-in вывод: запустить внешнюю переписывающую команду (аудит 2026-08-25). Команда берётся из окружения HUMANIZER_REWRITE_CMD и
