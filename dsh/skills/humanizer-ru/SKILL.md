...
Ограничение инструментов из `allowed-tools` исполняет Claude Code; DeepSeek Harness (dsh) этот ключ не интерпретирует — в dsh запрет на файлы, код и сеть держится только на этих четырёх правилах.
