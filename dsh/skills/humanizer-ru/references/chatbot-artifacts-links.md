...
| `<ref name="0search12">` (добавлено в v3.4, класс B) | Имя сноски в вики-разметке: числовой префикс + имя внутреннего инструмента. Оно может остаться при копировании ответа агента с веб-поиском | `<ref\b[^>]{0,500}\bname=["']\d+(?:search\|fetch\|file\|image\|news\|video\|ref)\d+["']` |
