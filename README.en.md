...
Shares of “0 of N” are published with a confidence interval and a date: zero false positives on 11 human texts is a snapshot of the 2026-08-25 run (an observation of 0/11, Wilson 95% CI [0%; 25.9%]), not a property of the detector — in the 2026-08-31 replicate of the same judge line two of 11 human texts crossed the accusation threshold (2/11, Wilson 95% CI [5.1%; 47.7%]). Neither figure is quoted without its date (ERRATA.md). scripts/check_confidence.py recomputes and cross-checks the intervals.
