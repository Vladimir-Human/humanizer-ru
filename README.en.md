...
The full checklist runs in one command: `python scripts/check_all.py` — 117 gates in the full checklist (106 in --quick). Unit tests: `python -m unittest discover -s tests`.
