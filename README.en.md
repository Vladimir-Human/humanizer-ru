...
git clone --branch v3.16.2 --depth 1 https://github.com/Vladimir-Human/humanizer-ru.git ~/.claude/skills/humanizer-ru
```
...
git clone --branch v3.16.2 --depth 1 https://github.com/Vladimir-Human/humanizer-ru.git ~/.agents/skills/humanizer-ru
```
...
jobs:
  humanizer:
    ...
    timeout-minutes: 10
    steps:
      - uses: Vladimir-Human/humanizer-ru/action@v3.16.2
        with:
...
`Vladimir-Human/humanizer-ru/action@v3.16.2`, not by the `ref` input.
