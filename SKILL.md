...
# Humanizer-ru — очеловечивание текста (v3.18.0)
...
| `tests/test-fixtures.md` | Образцы 1–15 и пары «до / после» — в отдельных файлах каталога. Проверочные данные, в бандл не входят | При обновлении скилла |
