...
# Humanizer-ru — очеловечивание текста (v2.6.0)
...
| `references/false-positives.md` | Что не считается признаком ИИ: длинное тире в художке, изогнутые кавычки от автозамены macOS, правило трёх в риторике и публицистике, канцелярит в юридическом тексте, академический и научный регистр | Перед вынесением вердикта о машинном происхождении |
