...
# Humanizer-ru — очеловечивание текста (v3.34.0)
...
Пользователь сообщил дату создания текста?
   — да, до ноября 2022, и дата подтверждена метаданными, публикацией или архивом → машинный текст этого периода невозможен; класс A артефакты и источники
