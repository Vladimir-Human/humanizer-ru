...
- Подтверждённый подлог источника из `references/source-fabrication.md` — только при оффлайн-доказуемом противоречии либо после проверки с сетью, разрешённой пользователем.
