---
name: humanizer-ru
description: "Use when: нужно очеловечить (humanize) сгенерированный ИИ текст на русском. Убирает 30 машинных паттернов, делает язык живым и естественным. Включает однозначные маркеры (regex) для копирования из ChatGPT, Gemini, Grok и проверку галлюцинированных источников."
license: MIT
