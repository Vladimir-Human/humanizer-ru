...
### Однозначные маркеры (новое в v2.3, расширено в v2.5 и v2.6)

Регулярные выражения для следов копирования из чат-ботов. Один такой маркер в обычном тексте — почти точно ИИ. Все выражения прогоняются автоматически: `python3 scripts/check_markers.py` — три уровня образцов на каждое, прогон обязателен в CI (18 из 18 проходят).
