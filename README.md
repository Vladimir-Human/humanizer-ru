...
Регулярные выражения для следов копирования из чат-ботов. Один такой маркер в обычном тексте — почти точно ИИ. Все выражения прогнаны на эталонных образцах (12 из 12 проходят прямые и отрицательные).
