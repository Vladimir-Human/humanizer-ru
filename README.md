...
В версии 2.3 скилл переведён на постепенное раскрытие: SKILL.md содержит карту и дерево решений (~17 КБ), полное описание паттернов и проверок — в подключаемых файлах `references/` (~120 КБ).
