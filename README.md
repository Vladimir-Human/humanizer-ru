...
Полный чек-лист — одна команда: `python scripts/check_all.py` — 55 гейтов полного чек-листа (51 в --quick). Юнит-тесты — `python -m unittest discover -s tests`.
