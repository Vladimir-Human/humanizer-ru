...
| [ilyautov/humanizer-ru](https://github.com/ilyautov/humanizer-ru) | Скилл-гуманизатор: в тэглайне заявлена подгонка под метрики GPTZero, DivEye, RuBERT, FAQ даёт технику обхода | Техника обхода — в их FAQ |
| [blader/humanizer](https://github.com/blader/humanizer) | Англоязычный скилл того же жанра, опубликован на три дня раньше | — |

Мы не аффилированы ни с одним из них. Декларация этого проекта: «снятие
меток — ценность продукта; обход детекторов не заявляется как гарантия»;
...
Полный чек-лист — одна команда: `python scripts/check_all.py` — 53 гейт полного чек-листа (49 в --quick). Юнит-тесты — `python -m unittest discover -s tests`.
