...
dsh сканирует собственные каталоги скиллов и **не читает** `~/.claude/skills` ни на одном уровне. Проверено с dsh 0.1.0-rc.6. Это developer preview: ломающие изменения обещаны, поэтому для другой версии сверяйтесь с её документацией.
