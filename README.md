...
### Однозначные маркеры (новое в v2.3, расширено в v2.5)

Регулярные выражения для следов копирования из чат-ботов. Один такой маркер в обычном тексте — почти точно ИИ. Все выражения прогнаны на эталонных образцах (16 из 16 проходят прямые и отрицательные).
