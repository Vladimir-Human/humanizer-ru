...
Использованы 19 сохранённых русскоязычных ответов: 5 GigaChat, 3 Алисы
и 4 Le Chat (получены 14 июля 2026), 4 DeepSeek-V3/R1 (дословные цитаты из
интервью на Хабре, публикация 2025-01-29, обращение 2026-08-11) и 3 Grok
...
vaniley/grok_answer_mail_ru). Файлы находятся в `research/raw/` и не
