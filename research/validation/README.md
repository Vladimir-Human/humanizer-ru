...
| `09-wikipedia-modern.txt` | энциклопедическая статья | Написан в проекте в регистре современной статьи сообщества Русской Википедии (энциклопедический регистр; примеры регистра смотрелись с обращением 2026-08-11). Не дословная копия: конкретной статье и ревизии не соответствует, revision не закрепляется |
| `10-wikinews.txt` | новостная заметка | Написан в проекте в регистре заметки Русских Викиновостей (новостной регистр без дат и имён собственных). Не дословная копия: конкретной заметке и ревизии не соответствует, revision не закрепляется |
