...
| `11-it-notation.txt` | бытовой рассказ о работе | Написан в проекте для проверки ложных срабатываний: офисные связки программ, складские номера, составные эмодзи, упоминание служебного тега. До сужения выражений в версии 3.7.0 давал девять ложных срабатываний, после — ноль |
