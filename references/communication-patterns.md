...
**Граница ложного срабатывания.** Реальный trade-off существует: «не в скорости, а в точности» в медицине — осмысленная дилемма, если обе альтернативы обсуждаются по существу. Маркер — дилемма из клише-пары, после которой ни X, ни Y не раскрываются. Отличать от #12 (отрицательный параллелизм): тот шире и часто содержателен; здесь — именно клише-пары с пустым итогом.
